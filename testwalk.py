...
from temp import PedestrianPathFollower
...
output_path = os.path.join(
    "/home/ygao/Dataset/habitat_sim", "video_output/"
)
...
def make_default_settings():
    settings = {
        "width": 640 ,#  480, Spatial resolution of the observations
        "height":480, # 270,
...
seed = 2
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00800-TEEsavR23oF/TEEsavR23oF.basis.glb" 
seed = 3
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00801-HaxA7YrQdEC/HaxA7YrQdEC.basis.glb"
seed = 8
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00802-wcojb4TFT35/wcojb4TFT35.basis.glb"  
seed = 3
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00803-k1cupFYWXJ6/k1cupFYWXJ6.basis.glb" 
seed = 3 
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00804-BHXhpBwSMLh/BHXhpBwSMLh.basis.glb" 
seed = 0
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00805-SUHsP6z2gcJ/SUHsP6z2gcJ.basis.glb" 
seed = 5
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00806-tQ5s4ShP627/tQ5s4ShP627.basis.glb" 
seed = 8
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00807-rsggHU7g7dh/rsggHU7g7dh.basis.glb" 
seed = 4
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00808-y9hTuugGdiq/y9hTuugGdiq.basis.glb" 
seed = 6
sim_settings["scene"] = "./data/scene_datasets/hm3d_minival/00809-Qpor2mEya8F/Qpor2mEya8F.basis.glb" 
# fmt: on

video_prefix = "walk_9"

sim_settings["sensor_pitch"] = -math.pi / 8.0
sim_settings["sensor_height"] = 1.0
sim_settings["color_sensor_3rd_person"] = False
sim_settings["color_sensor_1st_person"] = True
sim_settings["depth_sensor_1st_person"] = False
...
nylan = obj_attr_mgr.load_configs(
    # nylan, angry_girl, sonic,bender,fox
    str(os.path.join(data_path, "objects/nylan")),False
)[0]

fox = obj_attr_mgr.load_configs(
    # nylan, angry_girl, sonic,bender,fox
    str(os.path.join(data_path, "objects/fox")),False
)[0]
...
ped_1 = PedestrianPathFollower(sim,1,0.4,2,1,1,rigid_obj_mgr)
ped_1.initial_pedestrian_path(angry_girl)

ped_2 = PedestrianPathFollower(sim,1,0.4,4,1,1,rigid_obj_mgr)
...
ped_4 = PedestrianPathFollower(sim,1,0.4,4,1,1,rigid_obj_mgr)
ped_4.initial_pedestrian_path(nylan)
...
print(type(observations[0]['rgba_camera_1stperson']))
...
def additive_gauss_noise(img, sigma=5):
...
if save_image:
    for idx,obs in enumerate(observations):
        rgb_save_folder = '/home/ygao/Dataset/habitat_sim/JPEGImages/480p/' + video_prefix
        semantic_save_folder = '/home/ygao/Dataset/habitat_sim/Annotations/480p/' + video_prefix
        imageSets_folder = '/home/ygao/Dataset/habitat_sim/ImageSets/480p/val.txt'
        imageSets_folder_2017 = '/home/ygao/Dataset/habitat_sim/ImageSets/480p/val_2017.txt'
        ...
        with open(imageSets_folder, 'a') as f:
