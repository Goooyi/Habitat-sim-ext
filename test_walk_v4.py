...
def make_default_settings():
    settings = {
        "width": 1920 ,#  480, Spatial resolution of the observations
        "height":1080, # 270,
...
ped_1.initial_pedestrian_path(locobot_template_id)

ped_2 = PedestrianPathFollower(sim,1,0.4,4,1,1,rigid_obj_mgr)
ped_2.initial_pedestrian_path(locobot_template_id)

ped_3 = PedestrianPathFollower(sim,1,0.4,4,1,1,rigid_obj_mgr)
ped_3.initial_pedestrian_path(locobot_template_id)

ped_4 = PedestrianPathFollower(sim,1,0.4,4,1,1,rigid_obj_mgr)
ped_4.initial_pedestrian_path(locobot_template_id)
