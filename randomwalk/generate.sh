...
RANDOM=42
scene_folder="/home/gao/dev/Habitat-sim-ext/randomwalk/data/hm3d-val-glb-v0.2"
...
# i=0
# loop for 30 scenes
# for scene_file in $(find "$scene_folder" -name "*.glb" | shuf --random-source=<(echo 42) -e | head -n 5); do
